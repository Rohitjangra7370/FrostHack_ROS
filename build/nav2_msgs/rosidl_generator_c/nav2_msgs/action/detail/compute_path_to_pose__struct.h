...
enum
{
  nav2_msgs__action__ComputePathToPose_Result__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__UNKNOWN = 200
};

/// Constant 'INVALID_PLANNER'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__INVALID_PLANNER = 201
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__TF_ERROR = 202
};

/// Constant 'START_OUTSIDE_MAP'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__START_OUTSIDE_MAP = 203
};

/// Constant 'GOAL_OUTSIDE_MAP'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__GOAL_OUTSIDE_MAP = 204
};

/// Constant 'START_OCCUPIED'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__START_OCCUPIED = 205
};

/// Constant 'GOAL_OCCUPIED'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__GOAL_OCCUPIED = 206
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__TIMEOUT = 207
};

/// Constant 'NO_VALID_PATH'.
enum
{
  nav2_msgs__action__ComputePathToPose_Result__NO_VALID_PATH = 208
};
