...
/// Constant 'NO_WAYPOINTS_GIVEN'.
enum
{
  nav2_msgs__action__FollowGPSWaypoints_Result__NO_WAYPOINTS_GIVEN = 602
};

/// Constant 'STOP_ON_MISSED_WAYPOINT'.
enum
{
  nav2_msgs__action__FollowGPSWaypoints_Result__STOP_ON_MISSED_WAYPOINT = 603
};
