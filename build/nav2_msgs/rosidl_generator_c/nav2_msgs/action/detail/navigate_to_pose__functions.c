...
bool
nav2_msgs__action__NavigateToPose_Goal__are_equal(const nav2_msgs__action__NavigateToPose_Goal * lhs, const nav2_msgs__action__NavigateToPose_Goal * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
nav2_msgs__action__NavigateToPose_Goal__copy(
  const nav2_msgs__action__NavigateToPose_Goal * input,
  nav2_msgs__action__NavigateToPose_Goal * output)
{
  if (!input || !output) {
    return false;
  }
...
nav2_msgs__action__NavigateToPose_Goal__create()
{
  ...
  nav2_msgs__action__NavigateToPose_Goal * msg = (nav2_msgs__action__NavigateToPose_Goal *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_Goal__Sequence__init(nav2_msgs__action__NavigateToPose_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_Goal *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_Goal__Sequence * array = (nav2_msgs__action__NavigateToPose_Goal__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_Goal__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_Goal__Sequence * lhs, const nav2_msgs__action__NavigateToPose_Goal__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_Goal__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_Goal__Sequence * input,
  nav2_msgs__action__NavigateToPose_Goal__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_Goal * data =
      (nav2_msgs__action__NavigateToPose_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_Goal__copy(
...
bool
nav2_msgs__action__NavigateToPose_Result__are_equal(const nav2_msgs__action__NavigateToPose_Result * lhs, const nav2_msgs__action__NavigateToPose_Result * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
nav2_msgs__action__NavigateToPose_Result__copy(
  const nav2_msgs__action__NavigateToPose_Result * input,
  nav2_msgs__action__NavigateToPose_Result * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_Result * msg = (nav2_msgs__action__NavigateToPose_Result *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_Result__Sequence__init(nav2_msgs__action__NavigateToPose_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_Result *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_Result__Sequence * array = (nav2_msgs__action__NavigateToPose_Result__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_Result__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_Result__Sequence * lhs, const nav2_msgs__action__NavigateToPose_Result__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_Result__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_Result__Sequence * input,
  nav2_msgs__action__NavigateToPose_Result__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_Result * data =
      (nav2_msgs__action__NavigateToPose_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
nav2_msgs__action__NavigateToPose_Feedback__are_equal(const nav2_msgs__action__NavigateToPose_Feedback * lhs, const nav2_msgs__action__NavigateToPose_Feedback * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
nav2_msgs__action__NavigateToPose_Feedback__copy(
  const nav2_msgs__action__NavigateToPose_Feedback * input,
  nav2_msgs__action__NavigateToPose_Feedback * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_Feedback * msg = (nav2_msgs__action__NavigateToPose_Feedback *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_Feedback__Sequence__init(nav2_msgs__action__NavigateToPose_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_Feedback *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_Feedback__Sequence * array = (nav2_msgs__action__NavigateToPose_Feedback__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_Feedback__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_Feedback__Sequence * lhs, const nav2_msgs__action__NavigateToPose_Feedback__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_Feedback__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_Feedback__Sequence * input,
  nav2_msgs__action__NavigateToPose_Feedback__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_Feedback * data =
      (nav2_msgs__action__NavigateToPose_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Request__are_equal(const nav2_msgs__action__NavigateToPose_SendGoal_Request * lhs, const nav2_msgs__action__NavigateToPose_SendGoal_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // goal
  if (!nav2_msgs__action__NavigateToPose_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Request__copy(
  const nav2_msgs__action__NavigateToPose_SendGoal_Request * input,
  nav2_msgs__action__NavigateToPose_SendGoal_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_SendGoal_Request * msg = (nav2_msgs__action__NavigateToPose_SendGoal_Request *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence__init(nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_SendGoal_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence * array = (nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence * lhs, const nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence * input,
  nav2_msgs__action__NavigateToPose_SendGoal_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_SendGoal_Request * data =
      (nav2_msgs__action__NavigateToPose_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Response__are_equal(const nav2_msgs__action__NavigateToPose_SendGoal_Response * lhs, const nav2_msgs__action__NavigateToPose_SendGoal_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Response__copy(
  const nav2_msgs__action__NavigateToPose_SendGoal_Response * input,
  nav2_msgs__action__NavigateToPose_SendGoal_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_SendGoal_Response * msg = (nav2_msgs__action__NavigateToPose_SendGoal_Response *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence__init(nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_SendGoal_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence * array = (nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence * lhs, const nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence * input,
  nav2_msgs__action__NavigateToPose_SendGoal_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_SendGoal_Response * data =
      (nav2_msgs__action__NavigateToPose_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Request__are_equal(const nav2_msgs__action__NavigateToPose_GetResult_Request * lhs, const nav2_msgs__action__NavigateToPose_GetResult_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Request__copy(
  const nav2_msgs__action__NavigateToPose_GetResult_Request * input,
  nav2_msgs__action__NavigateToPose_GetResult_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_GetResult_Request * msg = (nav2_msgs__action__NavigateToPose_GetResult_Request *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence__init(nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_GetResult_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence * array = (nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence * lhs, const nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence * input,
  nav2_msgs__action__NavigateToPose_GetResult_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_GetResult_Request * data =
      (nav2_msgs__action__NavigateToPose_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Response__are_equal(const nav2_msgs__action__NavigateToPose_GetResult_Response * lhs, const nav2_msgs__action__NavigateToPose_GetResult_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // result
  if (!nav2_msgs__action__NavigateToPose_Result__are_equal(
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Response__copy(
  const nav2_msgs__action__NavigateToPose_GetResult_Response * input,
  nav2_msgs__action__NavigateToPose_GetResult_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_GetResult_Response * msg = (nav2_msgs__action__NavigateToPose_GetResult_Response *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence__init(nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_GetResult_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence * array = (nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence * lhs, const nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence * input,
  nav2_msgs__action__NavigateToPose_GetResult_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_GetResult_Response * data =
      (nav2_msgs__action__NavigateToPose_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
nav2_msgs__action__NavigateToPose_FeedbackMessage__are_equal(const nav2_msgs__action__NavigateToPose_FeedbackMessage * lhs, const nav2_msgs__action__NavigateToPose_FeedbackMessage * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // feedback
  if (!nav2_msgs__action__NavigateToPose_Feedback__are_equal(
...
bool
nav2_msgs__action__NavigateToPose_FeedbackMessage__copy(
  const nav2_msgs__action__NavigateToPose_FeedbackMessage * input,
  nav2_msgs__action__NavigateToPose_FeedbackMessage * output)
{
  if (!input || !output) {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_FeedbackMessage * msg = (nav2_msgs__action__NavigateToPose_FeedbackMessage *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence__init(nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__NavigateToPose_FeedbackMessage *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__NavigateToPose_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence * array = (nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence__are_equal(const nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence * lhs, const nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence__copy(
  const nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence * input,
  nav2_msgs__action__NavigateToPose_FeedbackMessage__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__action__NavigateToPose_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__action__NavigateToPose_FeedbackMessage * data =
      (nav2_msgs__action__NavigateToPose_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__NavigateToPose_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__NavigateToPose_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__action__NavigateToPose_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
