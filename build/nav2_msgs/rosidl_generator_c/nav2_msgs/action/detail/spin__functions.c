...
nav2_msgs__action__Spin_Goal__create()
{
  ...
  nav2_msgs__action__Spin_Goal * msg = (nav2_msgs__action__Spin_Goal *)allocator.allocate(sizeof(nav2_msgs__action__Spin_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_Goal__Sequence__init(nav2_msgs__action__Spin_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_Goal *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_Goal__Sequence * array = (nav2_msgs__action__Spin_Goal__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_Goal * data =
      (nav2_msgs__action__Spin_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_Result * msg = (nav2_msgs__action__Spin_Result *)allocator.allocate(sizeof(nav2_msgs__action__Spin_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_Result__Sequence__init(nav2_msgs__action__Spin_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_Result *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_Result__Sequence * array = (nav2_msgs__action__Spin_Result__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_Result * data =
      (nav2_msgs__action__Spin_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_Feedback * msg = (nav2_msgs__action__Spin_Feedback *)allocator.allocate(sizeof(nav2_msgs__action__Spin_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_Feedback__Sequence__init(nav2_msgs__action__Spin_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_Feedback *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_Feedback__Sequence * array = (nav2_msgs__action__Spin_Feedback__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_Feedback * data =
      (nav2_msgs__action__Spin_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_SendGoal_Request * msg = (nav2_msgs__action__Spin_SendGoal_Request *)allocator.allocate(sizeof(nav2_msgs__action__Spin_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_SendGoal_Request__Sequence__init(nav2_msgs__action__Spin_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_SendGoal_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_SendGoal_Request__Sequence * array = (nav2_msgs__action__Spin_SendGoal_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_SendGoal_Request * data =
      (nav2_msgs__action__Spin_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_SendGoal_Response * msg = (nav2_msgs__action__Spin_SendGoal_Response *)allocator.allocate(sizeof(nav2_msgs__action__Spin_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_SendGoal_Response__Sequence__init(nav2_msgs__action__Spin_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_SendGoal_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_SendGoal_Response__Sequence * array = (nav2_msgs__action__Spin_SendGoal_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_SendGoal_Response * data =
      (nav2_msgs__action__Spin_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_GetResult_Request * msg = (nav2_msgs__action__Spin_GetResult_Request *)allocator.allocate(sizeof(nav2_msgs__action__Spin_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_GetResult_Request__Sequence__init(nav2_msgs__action__Spin_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_GetResult_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_GetResult_Request__Sequence * array = (nav2_msgs__action__Spin_GetResult_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_GetResult_Request * data =
      (nav2_msgs__action__Spin_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_GetResult_Response * msg = (nav2_msgs__action__Spin_GetResult_Response *)allocator.allocate(sizeof(nav2_msgs__action__Spin_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_GetResult_Response__Sequence__init(nav2_msgs__action__Spin_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_GetResult_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_GetResult_Response__Sequence * array = (nav2_msgs__action__Spin_GetResult_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_GetResult_Response * data =
      (nav2_msgs__action__Spin_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_FeedbackMessage * msg = (nav2_msgs__action__Spin_FeedbackMessage *)allocator.allocate(sizeof(nav2_msgs__action__Spin_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__action__Spin_FeedbackMessage__Sequence__init(nav2_msgs__action__Spin_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__action__Spin_FeedbackMessage *)allocator.zero_allocate(size, sizeof(nav2_msgs__action__Spin_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__action__Spin_FeedbackMessage__Sequence * array = (nav2_msgs__action__Spin_FeedbackMessage__Sequence *)allocator.allocate(sizeof(nav2_msgs__action__Spin_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__action__Spin_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__action__Spin_FeedbackMessage * data =
      (nav2_msgs__action__Spin_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__action__Spin_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__action__Spin_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
