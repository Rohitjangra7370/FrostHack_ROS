...
class Init_AssistedTeleop_Result_error_msg
{
public:
  explicit Init_AssistedTeleop_Result_error_msg(::nav2_msgs::action::AssistedTeleop_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::AssistedTeleop_Result error_msg(::nav2_msgs::action::AssistedTeleop_Result::_error_msg_type arg)
  {
...
class Init_AssistedTeleop_Result_error_code
{
public:
  explicit Init_AssistedTeleop_Result_error_code(::nav2_msgs::action::AssistedTeleop_Result & msg)
  : msg_(msg)
  {}
  Init_AssistedTeleop_Result_error_msg error_code(::nav2_msgs::action::AssistedTeleop_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_AssistedTeleop_Result_error_msg(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AssistedTeleop_Result_error_code total_elapsed_time(::nav2_msgs::action::AssistedTeleop_Result::_total_elapsed_time_type arg)
  {
    msg_.total_elapsed_time = std::move(arg);
    return Init_AssistedTeleop_Result_error_code(msg_);
  }
