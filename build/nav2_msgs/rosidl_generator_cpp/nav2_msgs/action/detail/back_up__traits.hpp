...
inline std::string to_yaml(const BackUp_Goal & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const BackUp_Result & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline std::string to_yaml(const BackUp_Feedback & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const BackUp_SendGoal_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const BackUp_SendGoal_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const BackUp_SendGoal_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: accepted
...
inline std::string to_yaml(const BackUp_SendGoal_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const BackUp_GetResult_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const BackUp_GetResult_Request & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const BackUp_GetResult_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: status
...
inline std::string to_yaml(const BackUp_GetResult_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline void to_flow_style_yaml(
  const BackUp_FeedbackMessage & msg,
  std::ostream & out)
{
  out << "{";
  // member: goal_id
...
inline std::string to_yaml(const BackUp_FeedbackMessage & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
