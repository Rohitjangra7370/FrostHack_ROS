...
class Init_DriveOnHeading_Goal_disable_collision_checks
{
public:
  explicit Init_DriveOnHeading_Goal_disable_collision_checks(::nav2_msgs::action::DriveOnHeading_Goal & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::DriveOnHeading_Goal disable_collision_checks(::nav2_msgs::action::DriveOnHeading_Goal::_disable_collision_checks_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_DriveOnHeading_Goal_disable_collision_checks time_allowance(::nav2_msgs::action::DriveOnHeading_Goal::_time_allowance_type arg)
  {
    msg_.time_allowance = std::move(arg);
    return Init_DriveOnHeading_Goal_disable_collision_checks(msg_);
  }
...
class Init_DriveOnHeading_Result_error_msg
{
public:
  explicit Init_DriveOnHeading_Result_error_msg(::nav2_msgs::action::DriveOnHeading_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::DriveOnHeading_Result error_msg(::nav2_msgs::action::DriveOnHeading_Result::_error_msg_type arg)
  {
...
class Init_DriveOnHeading_Result_error_code
{
public:
  explicit Init_DriveOnHeading_Result_error_code(::nav2_msgs::action::DriveOnHeading_Result & msg)
  : msg_(msg)
  {}
  Init_DriveOnHeading_Result_error_msg error_code(::nav2_msgs::action::DriveOnHeading_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_DriveOnHeading_Result_error_msg(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_DriveOnHeading_Result_error_code total_elapsed_time(::nav2_msgs::action::DriveOnHeading_Result::_total_elapsed_time_type arg)
  {
    msg_.total_elapsed_time = std::move(arg);
    return Init_DriveOnHeading_Result_error_code(msg_);
  }
