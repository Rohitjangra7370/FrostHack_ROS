...
{
public:
  explicit Init_FollowWaypoints_Goal_poses(::nav2_msgs::action::FollowWaypoints_Goal & msg)
  : msg_(msg)
  {}
...
class Init_FollowWaypoints_Goal_goal_index
{
public:
  explicit Init_FollowWaypoints_Goal_goal_index(::nav2_msgs::action::FollowWaypoints_Goal & msg)
  : msg_(msg)
  {}
  Init_FollowWaypoints_Goal_poses goal_index(::nav2_msgs::action::FollowWaypoints_Goal::_goal_index_type arg)
  {
    msg_.goal_index = std::move(arg);
    return Init_FollowWaypoints_Goal_poses(msg_);
  }
...
class Init_FollowWaypoints_Goal_number_of_loops
{
public:
  Init_FollowWaypoints_Goal_number_of_loops()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FollowWaypoints_Goal_goal_index number_of_loops(::nav2_msgs::action::FollowWaypoints_Goal::_number_of_loops_type arg)
  {
    msg_.number_of_loops = std::move(arg);
    return Init_FollowWaypoints_Goal_goal_index(msg_);
  }
...
{
  return nav2_msgs::action::builder::Init_FollowWaypoints_Goal_number_of_loops();
}
...
class Init_FollowWaypoints_Result_error_msg
{
public:
  explicit Init_FollowWaypoints_Result_error_msg(::nav2_msgs::action::FollowWaypoints_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::FollowWaypoints_Result error_msg(::nav2_msgs::action::FollowWaypoints_Result::_error_msg_type arg)
  {
...
class Init_FollowWaypoints_Result_error_code
{
public:
  explicit Init_FollowWaypoints_Result_error_code(::nav2_msgs::action::FollowWaypoints_Result & msg)
  : msg_(msg)
  {}
  Init_FollowWaypoints_Result_error_msg error_code(::nav2_msgs::action::FollowWaypoints_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_FollowWaypoints_Result_error_msg(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FollowWaypoints_Result_error_code missed_waypoints(::nav2_msgs::action::FollowWaypoints_Result::_missed_waypoints_type arg)
  {
    msg_.missed_waypoints = std::move(arg);
    return Init_FollowWaypoints_Result_error_code(msg_);
  }
