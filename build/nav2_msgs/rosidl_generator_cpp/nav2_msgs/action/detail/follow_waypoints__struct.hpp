...
struct FollowWaypoints_Result_
{
  ...
  static constexpr uint16_t TASK_EXECUTOR_FAILED =
    601u;
  static constexpr uint16_t NO_VALID_WAYPOINTS =
    602u;
...
constexpr uint16_t FollowWaypoints_Result_<ContainerAllocator>::NONE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowWaypoints_Result_<ContainerAllocator>::UNKNOWN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowWaypoints_Result_<ContainerAllocator>::TASK_EXECUTOR_FAILED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowWaypoints_Result_<ContainerAllocator>::NO_VALID_WAYPOINTS;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowWaypoints_Result_<ContainerAllocator>::STOP_ON_MISSED_WAYPOINT;
#endif  // __cplusplus < 201703L
