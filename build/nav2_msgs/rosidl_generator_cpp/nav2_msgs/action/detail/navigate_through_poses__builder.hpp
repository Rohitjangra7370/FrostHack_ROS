...
class Init_NavigateThroughPoses_Result_error_msg
{
public:
  explicit Init_NavigateThroughPoses_Result_error_msg(::nav2_msgs::action::NavigateThroughPoses_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::NavigateThroughPoses_Result error_msg(::nav2_msgs::action::NavigateThroughPoses_Result::_error_msg_type arg)
  {
...
class Init_NavigateThroughPoses_Result_error_code
{
public:
  Init_NavigateThroughPoses_Result_error_code()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_NavigateThroughPoses_Result_error_msg error_code(::nav2_msgs::action::NavigateThroughPoses_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_NavigateThroughPoses_Result_error_msg(msg_);
  }
...
{
  return nav2_msgs::action::builder::Init_NavigateThroughPoses_Result_error_code();
}
