...
class Init_SmoothPath_Result_error_msg
{
public:
  explicit Init_SmoothPath_Result_error_msg(::nav2_msgs::action::SmoothPath_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::SmoothPath_Result error_msg(::nav2_msgs::action::SmoothPath_Result::_error_msg_type arg)
  {
...
class Init_SmoothPath_Result_error_code
{
public:
  explicit Init_SmoothPath_Result_error_code(::nav2_msgs::action::SmoothPath_Result & msg)
  : msg_(msg)
  {}
  Init_SmoothPath_Result_error_msg error_code(::nav2_msgs::action::SmoothPath_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_SmoothPath_Result_error_msg(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SmoothPath_Result_error_code was_completed(::nav2_msgs::action::SmoothPath_Result::_was_completed_type arg)
  {
    msg_.was_completed = std::move(arg);
    return Init_SmoothPath_Result_error_code(msg_);
  }
