...
struct SmoothPath_Result_
{
  ...
  static constexpr uint16_t UNKNOWN =
    500u;
  static constexpr uint16_t INVALID_SMOOTHER =
    501u;
  static constexpr uint16_t TIMEOUT =
    502u;
  static constexpr uint16_t SMOOTHED_PATH_IN_COLLISION =
    503u;
  static constexpr uint16_t FAILED_TO_SMOOTH_PATH =
    504u;
...
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::NONE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::UNKNOWN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::INVALID_SMOOTHER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::TIMEOUT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::SMOOTHED_PATH_IN_COLLISION;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::FAILED_TO_SMOOTH_PATH;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Result_<ContainerAllocator>::INVALID_PATH;
#endif  // __cplusplus < 201703L
