...
class Init_Wait_Result_error_msg
{
public:
  explicit Init_Wait_Result_error_msg(::nav2_msgs::action::Wait_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::Wait_Result error_msg(::nav2_msgs::action::Wait_Result::_error_msg_type arg)
  {
...
class Init_Wait_Result_error_code
{
public:
  explicit Init_Wait_Result_error_code(::nav2_msgs::action::Wait_Result & msg)
  : msg_(msg)
  {}
  Init_Wait_Result_error_msg error_code(::nav2_msgs::action::Wait_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_Wait_Result_error_msg(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Wait_Result_error_code total_elapsed_time(::nav2_msgs::action::Wait_Result::_total_elapsed_time_type arg)
  {
    msg_.total_elapsed_time = std::move(arg);
    return Init_Wait_Result_error_code(msg_);
  }
