...
class Init_BehaviorTreeStatusChange_uid
{
public:
  explicit Init_BehaviorTreeStatusChange_uid(::nav2_msgs::msg::BehaviorTreeStatusChange & msg)
  : msg_(msg)
  {}
  Init_BehaviorTreeStatusChange_previous_status uid(::nav2_msgs::msg::BehaviorTreeStatusChange::_uid_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_BehaviorTreeStatusChange_uid node_name(::nav2_msgs::msg::BehaviorTreeStatusChange::_node_name_type arg)
  {
    msg_.node_name = std::move(arg);
    return Init_BehaviorTreeStatusChange_uid(msg_);
  }
