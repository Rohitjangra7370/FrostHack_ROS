...
class Init_MissedWaypoint_error_msg
{
public:
  explicit Init_MissedWaypoint_error_msg(::nav2_msgs::msg::MissedWaypoint & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::msg::MissedWaypoint error_msg(::nav2_msgs::msg::MissedWaypoint::_error_msg_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_MissedWaypoint_error_msg error_code(::nav2_msgs::msg::MissedWaypoint::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_MissedWaypoint_error_msg(msg_);
  }
