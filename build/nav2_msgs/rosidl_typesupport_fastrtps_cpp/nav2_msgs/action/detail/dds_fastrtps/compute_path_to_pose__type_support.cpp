  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::action::ComputePathToPose_Goal;
    is_plain =
      (
...
static size_t _ComputePathToPose_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_Goal(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_Result;
    is_plain =
      (
...
static size_t _ComputePathToPose_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_Result(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_Feedback;
    is_plain =
      (
...
static size_t _ComputePathToPose_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_Feedback(full_bounded, is_plain, 0);
...
// functions for nav2_msgs::action::ComputePathToPose_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_SendGoal_Request;
    is_plain =
      (
...
static size_t _ComputePathToPose_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_SendGoal_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_SendGoal_Response;
    is_plain =
      (
...
static size_t _ComputePathToPose_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_SendGoal_Response(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_GetResult_Request;
    is_plain =
      (
...
static size_t _ComputePathToPose_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_GetResult_Request(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for nav2_msgs::action::ComputePathToPose_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_GetResult_Response;
    is_plain =
      (
...
static size_t _ComputePathToPose_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_GetResult_Response(full_bounded, is_plain, 0);
...
// functions for nav2_msgs::action::ComputePathToPose_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::ComputePathToPose_FeedbackMessage;
    is_plain =
      (
...
static size_t _ComputePathToPose_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ComputePathToPose_FeedbackMessage(full_bounded, is_plain, 0);
