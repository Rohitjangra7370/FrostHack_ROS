...
#include "nav2_msgs/action/detail/navigate_to_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_Goal & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::action::NavigateToPose_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_Goal *>(
    untyped_ros_message);
...
static size_t _NavigateToPose_Goal__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_Goal(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_Goal)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: error_code
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_Result & ros_message)
{
  // Member: error_code
  cdr >> ros_message.error_code;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_Result__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_Result(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_Result)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: current_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_Feedback & ros_message)
{
  // Member: current_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_Feedback__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_Feedback(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_Feedback)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_Feedback__handle;
}
...
// functions for nav2_msgs::action::NavigateToPose_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NavigateToPose_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_SendGoal_Request(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_SendGoal_Request)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_SendGoal_Response(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_SendGoal_Response)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_SendGoal_Response__handle;
}
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_SendGoal)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_GetResult_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_GetResult_Request(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_GetResult_Request)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for nav2_msgs::action::NavigateToPose_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NavigateToPose_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_GetResult_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_GetResult_Response(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_GetResult_Response)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_GetResult_Response__handle;
}
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_GetResult)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_GetResult__handle;
}
...
// functions for nav2_msgs::action::NavigateToPose_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav2_msgs
cdr_serialize(
  const nav2_msgs::action::NavigateToPose_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::action::NavigateToPose_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav2_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_NavigateToPose_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nav2_msgs::action::NavigateToPose_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::action::NavigateToPose_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nav2_msgs::action::NavigateToPose_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _NavigateToPose_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_NavigateToPose_FeedbackMessage(full_bounded, is_plain, 0);
...
{
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, action, NavigateToPose_FeedbackMessage)() {
  return &nav2_msgs::action::typesupport_fastrtps_cpp::_NavigateToPose_FeedbackMessage__handle;
}
