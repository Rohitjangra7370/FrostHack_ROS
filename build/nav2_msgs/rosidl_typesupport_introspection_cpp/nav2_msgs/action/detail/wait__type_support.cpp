...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Wait_Result_message_member_array[3] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::action::Wait_Result, error_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
