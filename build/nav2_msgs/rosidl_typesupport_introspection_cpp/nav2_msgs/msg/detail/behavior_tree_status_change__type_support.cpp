...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BehaviorTreeStatusChange_message_member_array[5] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::msg::BehaviorTreeStatusChange, uid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
