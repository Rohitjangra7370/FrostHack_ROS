...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MissedWaypoint_message_member_array[4] = {
  {
    "index",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::msg::MissedWaypoint, error_msg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
